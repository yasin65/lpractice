    ...
    <div id="header">
      <div id="logo">
        <div id="logo_text">
          ...
          <h2><a href="{{URL::to('/')}}">Simple. Contemporary. Website Template.</a></h2>
        </div>
      </div>
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="{{route('inform')}}">Contact Information</a></li>
          <li><a href="{{route('contact')}}">Contact Us</a></li>
          
          <li><a href="{{route('contact1')}}">Contact1 </a></li>
          <li><a href="{{URL::to('/page')}}">A Page</a></li>
           <li><a href="{{URL::to('/another')}}">Another Page</a></li>
           <li><a href="{{URL::to('/example')}}">Examples</a></li>
