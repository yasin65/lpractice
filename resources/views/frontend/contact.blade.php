...
@section('content')
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <form method="post" action="{{route('submit1')}}">
          @csrf
          <div class="form_settings">
            <p><span>R id</span><input class="contact" type="text" name="r_id" value="" /></p>

            <p><span>Email Address</span><input class="contact" type="text" name="email" value="" /></p>

            <!-- <p><span>Photo</span><input class="contact" type="file" name="image" value="" /></p> -->
